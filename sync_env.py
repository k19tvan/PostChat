...
def sync_env():
    ui_env_path = "/home/enn/workspace/PostExtraction/ui/.env.local"
    ...
    if not url or not key:
        print("Error: Could not find Supabase URL or Key in .env.local")
        return

    content = f"""// This file is generated from ui/.env.local
